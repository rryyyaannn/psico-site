...
export function Hero({ settings }: { settings: Settings }) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[rgb(var(--bg))] to-[rgb(var(--surface))] min-h-[85vh] flex items-center">
      ...
      {/* Conteúdo */}
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-24 grid lg:grid-cols-2 gap-12 items-center">
        {/* Coluna de Texto */}
        <div className="space-y-6">
          ...
          <p className="text-lg md:text-xl text-[rgb(var(--muted))] leading-relaxed max-w-lg font-light">
            {settings.shortBio}
          </p>
        ...
        {/* Coluna de Imagem - Integrada ao Layout */}
